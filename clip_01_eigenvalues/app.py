    ...
    if state >= 9:
        ...
        <body>
            ...
            <script>
                ...
                // Locked 10/10 TV Camera (Full Pitch Visibility)
                ...
                // 2. Balanced 3D Stadium Lighting
                ...
                // Angled Key Light for 3D Specular Sheen & Depth
                ...
                // Helper: Soft Radial Ground Contact Shadow
                function createContactShadowTexture() {{
                    ...
                    grad.addColorStop(0, 'rgba(15, 30, 15, 0.70)');
                    grad.addColorStop(0.5, 'rgba(20, 45, 20, 0.30)');
                ...
                if (currentState >= 10) {{
                    ...
                    // 2. Base 3D Sphere with Specular Highlights
