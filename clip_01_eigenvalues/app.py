...
# Slides 1–3 (True TV-Grade WebGL 3D Visualization)
# 9th commit for slide 3 for click 4 and 5 
...
.webgl-stage-box {
    ...
    height: 68vh;
    z-index: 10;
    pointer-events: none; /* Passes clicks straight to Streamlit */
}
...
# ============================================================
# STATES 8–12 — SLIDE 3 (TRUE WEBGL 3D STAGE)
# ============================================================
        ...
        <body>
            ...
            <script>
                ...
                if (currentState >= 11) {{
                    ...
                    // Make ball translucent so interior O(0,0,0) is visible
                    if (ball) {{
                ...
                // Project 3D Coordinates to Screen Badges
